...
public enum  CodeMessage {
	...
	public String getMessage(String key, String... params) throws CanNotFindMessageException, MessagePropertiesLoadingException {
		...
		if(this.resourcebundle == null){
			//TODO : throw exception
			throw new MessagePropertiesLoadingException(new Message("code message properties 가 로딩 되지 않았습니다."));
		}
		...
		try {
			...
			//TODO : throw exception
			throw new CanNotFindMessageException(e, new Message("message properties -> "+resource+" 에코드("+key+")에 해당하는 메시지가 존재 하지 않습니다."));
		}
		return result;
	}
}
